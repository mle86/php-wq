    ...
    extends TestCase
{
     ...
     */
    public function testEmpty(WorkServerAdapter $ws)
    {
     ...
     * @param WorkServerAdapter $ws
     */
    public function testStoreAndForget(WorkServerAdapter $ws)
    {
     ...
     * @param WorkServerAdapter $ws
     */
    public function testStillEmptyAfterStoringJobs(WorkServerAdapter $ws)
    {
        $this->testEmpty($ws);
    }
